...
html_docs <- list.files(paste0(here(), "/_site"), pattern = "*.html")

for (doc in html_docs) {
  
  raw_html <- readLines(paste0(here(), "/_site/", doc))
...
browseURL(paste0(here(), "/_site/index.html"))
